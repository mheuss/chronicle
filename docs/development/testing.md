...
The `screencapturekit-rs` crate links against Swift concurrency libraries. Test
binaries that instantiate `SCStream` or `SCShareableContent` need this path set
or they crash with SIGABRT.
